...
- Python 3.11+
- An [Ollama](https://ollama.com) server with at least one Qwen model pulled (defaults to `qwen3:14b`)

## Configuration (environment variables)

| Variable | Default | Description |
|---|---|---|
| `QWEN_MODEL` | `qwen3:14b` | Ollama model to use |
